# -*- coding: utf-8 -*-
# Generated by Django 1.9.8 on 2016-11-23 20:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rater', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='moviereviewapp.Rater')),
            ],
        ),
        migrations.AddField(
            model_name='average',
            name='movie',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='moviereviewapp.Movie'),
        ),
    ]
